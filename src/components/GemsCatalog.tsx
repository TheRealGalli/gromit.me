...
const GEMS_DATA: Gem[] = [
  ...
  { 
    ...
    category: "Settore Immobiliare", 
    price: 49, 
    name: "Allestimento Immagini Immobiliari", 
  ...
  { 
    ...
    category: "Settore Immobiliare", 
    price: 49, 
    name: "Pulizia Immagini Immobiliari", 
                  ...
                  >
                    ...
                    <div className="flex flex-col gap-1 flex-1 min-w-0">
                      <div className="flex items-center justify-between gap-2">
                        ...
                        <span className="text-[11px] font-black text-google-blue flex-shrink-0">€{gem.price}</span>
                      </div>
